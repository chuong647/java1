...
public class ValidationUserFilter extends HttpFilter implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
		...
		if(hoTen.isEmpty() || diaChi.isEmpty() || sdt.isEmpty() || email.isEmpty()
			...
			httpRes.sendRedirect("/cuongddph14896_assimant/user/users");
			return ;
		}
...
//		ArrayList<User> lst = (ArrayList<User>) this.UserDAO.all();
//		User entity = new User();
//		lst.add(entity);
//		if(entity.getEmail().equals(email)) {
//			session.setAttribute("error", "Email bị trùng ");
//			httpRes.sendRedirect("/cuongddph14896_assimant/user/users");
//			return;
//		}
//		if(entity.getSdt().equals(sdt)) {
//			session.setAttribute("error", "số điện thoại bị trùng");
//			httpRes.sendRedirect("/cuongddph14896_assimant/user/users");
//			return;
//		}
