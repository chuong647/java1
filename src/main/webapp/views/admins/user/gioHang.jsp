...
<form action="/cuongddph14896_assimant/home/thanhToan" method="post">
				...
				<tbody>					
					<c:forEach items="${ hdctLstInUser }" var="hdctLstInUser">
						<tr>
							...
							<td>
								<img class="card-img-top" style="width: 100px;height: 150px" src="/cuongddph14896_assimant/img/${ hdctLstInUser.product.img }">
							</td>
							<td>
								<a class="btn btn-danger" 
									href="/cuongddph14896_assimant/home/deleteProductByUser?id=${ hdctLstInUser.id }">
										bỏ sản phẩm này
								</a>
							</td>
						</tr>
