...
<a href="/cuongddph14896_assimant/hoaDon/hoaDonKhachHang" class="btn btn-default border-dark">Quay về</a>	
				...
				<tbody>					
					<c:forEach items="${ hdct }" var="hdct">
						<tr>
							...
							<td>
								<img class="card-img-top" style="width: 100px;height: 150px" src="/cuongddph14896_assimant/img/${ hdct.product.img }">
							</td>
						</tr>
					</c:forEach>					
			</tbody>										
