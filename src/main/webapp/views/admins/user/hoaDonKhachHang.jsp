...
<form action="/cuongddph14896_assimant/hoaDon/DongYDonHang" method="post">
						...
						<tr>
							...
							<td>
								<a class="btn btn-primary" 
									href="/cuongddph14896_assimant/hoaDon/showHoaDonChiTiet?id=${ hd.id }">
										Xem hóa đơn chỉ tiết
								</a>
							</td>
							<td>
								<a class="btn btn-danger" 
									href="/cuongddph14896_assimant/hoaDon/HuyBoDonHang?id=${ hd.id }">
										Hủy bỏ đơn hàng
								</a>
							</td>							
						</tr>
